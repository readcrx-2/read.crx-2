    ...
    static initClass() {
      ...
      */
      this._dbOpen = new Promise( function(resolve, reject) {
          ...
          req.onerror = reject;
          req.onupgradeneeded = function({ target: {result: db, transaction: tx} }) {
    ...
    */
    async get() {
      try {
        ...
        for (var key in data) {
          const val = data[key];
          const newKey = (() => { switch (key) {
            case "last_updated": return "lastUpdated";
            case "last_modified": return "lastModified";
            case "res_length": return "resLength";
            case "dat_size": return "datSize";
            case "readcgi_ver": return "readcgiVer";
            default: return key;
          } })();
    ...
    */
    async put() {
      if ((typeof this.key !== "string") ||
          (((this.data == null) || (typeof this.data !== "string")) && ((this.parsed == null) || !(this.parsed instanceof Object))) ||
          (typeof this.lastUpdated !== "number") ||
          (!(this.lastModified == null) && (typeof this.lastModified !== "number")) ||
      ...
      const data = (this.data != null) ? app.replaceAll(this.data, "\u0000", "\u0020") : null;
